...
class GatewayHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if self.path.startswith("/assets/"):
            self._send_file(self.dist_dir / self.path.lstrip("/"))
            return
...
def main() -> None:
    ...
    parser.add_argument("--legacy-live", default="Milestone_1/live_analysis/web")
    parser.add_argument("--legacy-replay", default="Milestone_1/replay_dashboard/web")
