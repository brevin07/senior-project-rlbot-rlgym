...
def build_rlgym_v2_env(log_dir="reward_logs"):
    ...
    reward_fn = CombinedReward(
        ...
        # 2. DEFENSE (The Queen) - NEW!
        # Pays 5.0 for saving a shot. High priority.
        (ManualSaveReward(), 5.0),

        # 3. OFFENSE (The Driver)
        (VelocityBallToGoalReward(), 3.0),

        # 4. CONTROL (The Glue)
        # Keeps them dribbling.
        (TouchReward(), 2.0),
...
if __name__ == "__main__":
    ...
    learner = Learner(
       ...
       checkpoint_load_folder="D:\\PycharmProjects\\RLGym_Bot_Training\\rlbot\\data\\checkpoints\\rlgym-ppo-run-1768810976966950700\\1999115960"
    )
    learner.learn()
    input()