...
def maybe_rewrite_explanation(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    max_tokens = int(os.environ.get("RLBOT_LLM_MAX_TOKENS", "56") or "56")
    timeout_s = int(os.environ.get("RLBOT_LLM_TIMEOUT_S", "5") or "5")
        ...
        "input": [
            {
                ...
                "content": (
                    ...
                    "Output exactly 2 short sentences with concise coaching."
                ),
            },
            {
                "role": "user",
...
def maybe_rewrite_explanations_batch(events: List[Dict[str, Any]]) -> Dict[str, str]:
    ...
    api_key = str(os.environ.get("OPENAI_API_KEY", "")).strip()
    model = str(os.environ.get("RLBOT_LLM_MODEL", "gpt-4o-mini") or "gpt-4o-mini")
    max_tokens = int(os.environ.get("RLBOT_LLM_BATCH_MAX_TOKENS", "480") or "480")
    chunk_size = int(os.environ.get("RLBOT_LLM_BATCH_CHUNK_SIZE", "12") or "12")
    timeout_s = int(os.environ.get("RLBOT_LLM_BATCH_TIMEOUT_S", "6") or "6")
